...
`,education:[{jobTitle:"5yr-MSc Telecoms & Digital Signal Processing",company:"ESIEE-Paris",location:"France",date:"1999",content:"equivalent"},{jobTitle:"MSc Telecoms",company:"King's College London",location:"UK",date:"1998",content:"non-award exchange student"},{jobTitle:"Postgraduate Diploma in Management Studies",location:"bucks.ac.uk",date:"2002",content:"part-time"}]},p=()=>e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"x-colored",style:{fontSize:"1.8rem"},children:a.fullname}),e.jsx("p",{className:"x-colored",style:{fontSize:"1.1rem",margin:"0 auto 0.5rem"},children:a.jobTitle}),e.jsxs("p",{children:[e.jsx(o,{className:"fa-solid fa-phone-volume"})," ",a.phone,e.jsx(o,{className:"fa-solid fa-envelope"})," ",a.email,e.jsx(o,{className:"fa-solid fa-house"})," ",a.address,e.jsx(o,{className:"fa-solid fa-passport"})," ",a.nationality]})]}),o=t=>{const n={...t,className:"x-icon "+t.className};return e.jsx("i",{...n})},g=()=>{const t=a.fullname.split(" ").at(-1),n=new Date().toISOString().substring(0,10),i=`CV_${t}_Python_${n}`;return document.title=i,e.jsxs("header",{className:"x-no-print",children:[e.jsx(u,{variant:"dark",onClick:()=>window.print(),style:{padding:"0 0.5rem",marginBottom:"0.5rem"},children:"Print to PDF"}),e.jsxs("p",{children:["Click and select ",e.jsx("em",{children:"Save as PDF"})," to save as ",e.jsxs("code",{children:[i,".pdf"]}),"."]}),e.jsxs("p",{children:["NB: disable ",e.jsx("em",{children:"Headers and footers"}),"."]})]})},h=({item:t})=>{const n="x-heading-"+t.company.toLowerCase().replaceAll(" ","-");return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"clearfix","data-testid":n,style:{textAlign:"left",marginTop:"0.8rem"},children:[e.jsx("span",{className:"x-title",children:t.jobTitle})," |"," ",e.jsx("span",{className:"x-company",children:t.company}),", ",t.location,". (",t.sector,")",e.jsx("span",{className:"x-date",children:t.date})]}),e.jsx("div",{style:{textAlign:"justify"},children:r(t.content)})]})},b=({item:t})=>e.jsxs("div",{className:"clearfix",style:{textAlign:"left",marginTop:"0.2rem"},children:[e.jsx("span",{className:"x-title",children:t.jobTitle})," ",t.content,"."," ",t.company&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"x-company",children:t.company}),","," "]}),t.location,e.jsx("span",{className:"x-date",children:t.date})]}),f=()=>(m(()=>{if(!document.querySelector(".x-print-page-break")){const t=document.createElement("div");t.classList.add("x-print-page-break");const n=document.querySelector(a.pageBreakSelector);n?(n.style.marginTop="0",n.parentNode.insertBefore(t,n)):alert("Cannot find where to put the page break: "+a.pageBreakSelector)}},[]),e.jsxs(e.Fragment,{children:[e.jsx(g,{}),e.jsxs("main",{children:[e.jsx(p,{}),e.jsx(s,{children:"Profile"}),e.jsx("ul",{id:"x-profile",children:a.profileLines.map((t,n)=>e.jsx("li",{children:r(t)},n))}),e.jsx(s,{children:"Skills"}),Object.entries(a.skills).map((t,n)=>{const[i,l]=t;return e.jsxs("div",{className:"x-skills-pair",children:[e.jsxs("div",{className:"x-skills-group",children:[e.jsx("span",{className:"x-colored",children:i}),":"]}),e.jsx("div",{className:"x-skills-value",children:r(l)})]},n)}),e.jsx(s,{children:"Work Experience"}),a.jobs.map((t,n)=>e.jsx(h,{item:t},n)),e.jsx("p",{style:{textAlign:"left",marginTop:"0.8rem"},children:r(a.workExtra)}),e.jsx(s,{children:"Education"}),a.education.map((t,n)=>e.jsx(b,{item:t},n))]})]})),s=t=>{const n={...t,className:"x-section"+(t.className?" "+t.className:"")};return e.jsx("p",{...n,children:t.children})};c.createRoot(document.getElementById("root")).render(e.jsx(d.StrictMode,{children:e.jsx(f,{})}));
