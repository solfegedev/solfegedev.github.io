...
`,education:[{jobTitle:"5yr-MSc Telecoms & Digital Signal Processing",company:"ESIEE-Paris",location:"France",date:"1999",content:"equivalent"},{jobTitle:"MSc Telecoms",company:"King's College London",location:"UK",date:"1998",content:"non-award exchange student"},{jobTitle:"Postgraduate Diploma in Management Studies",location:"bucks.ac.uk",date:"2002",content:"part-time"}]},u=()=>e.jsxs(e.Fragment,{children:[e.jsx(p,{}),e.jsxs("main",{children:[e.jsx("p",{className:"x-colored",style:{fontSize:"1.8rem"},children:n.fullname}),e.jsx("p",{className:"x-colored",style:{fontSize:"1.1rem",margin:"0 auto 0.5rem"},children:n.jobTitle}),e.jsxs("p",{children:[e.jsx(s,{className:"fa-solid fa-phone-volume"})," ",n.phone,e.jsx(s,{className:"fa-solid fa-envelope"})," ",n.email,e.jsx(s,{className:"fa-solid fa-house"})," ",n.address,e.jsx(s,{className:"fa-solid fa-passport"})," ",n.nationality]}),e.jsx(a,{children:"Profile"}),e.jsx("ul",{children:n.profileLines.map((t,o)=>e.jsx("li",{children:r(t)},o))}),e.jsx(a,{children:"Skills"}),e.jsx("ul",{children:Object.entries(n.skills).map((t,o)=>{const[i,l]=t;return e.jsxs("li",{children:[e.jsx("span",{className:"x-colored",children:i}),": ",r(l)]},o)})}),e.jsx(a,{children:"Work Experience"}),n.jobs.map((t,o)=>e.jsx(g,{item:t},o)),e.jsx("p",{style:{textAlign:"left",marginTop:"0.8rem"},children:r(n.workExtra)}),e.jsx(a,{children:"Education"}),n.education.map((t,o)=>e.jsx(h,{item:t},o))]})]}),p=()=>{const t=n.fullname.split(" ").at(-1),o=new Date().toISOString().substring(0,10),i=`CV_${t}_Python_${o}`;return document.title=i,e.jsxs("header",{className:"x-no-print",children:[e.jsx(m,{variant:"dark",onClick:()=>window.print(),style:{padding:"0 0.5rem"},children:"Print as PDF"}),e.jsxs("p",{children:["To save as ",e.jsxs("code",{children:[i,".pdf"]}),", click ",e.jsx("strong",{children:"Print as PDF"}),","," ",e.jsx("strong",{children:"Save as PDF"}),", then expand ",e.jsx("strong",{children:"More settings"}),", set"," ",e.jsx("strong",{children:"Margins = Custom"})," (adjust 20mm each side), and tick"," ",e.jsx("strong",{children:"Background graphics"}),"."]}),e.jsxs("p",{children:["To add manual page break, open dev tool and add ",e.jsx("code",{children:"break-before:page"})," to first div of next page."]})]})},s=t=>e.jsx("i",{...t,className:"x-icon "+t.className}),a=t=>e.jsx("p",{className:"x-section",children:t.children}),g=({item:t})=>e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"clearfix",style:{textAlign:"left",marginTop:"0.8rem"},children:[e.jsx("span",{className:"x-title",children:t.jobTitle})," |"," ",e.jsx("span",{className:"x-company",children:t.company}),", ",t.location,". (",t.sector,")",e.jsx("span",{className:"x-date",children:t.date})]}),e.jsx("div",{style:{textAlign:"justify"},children:r(t.content)})]}),h=({item:t})=>e.jsxs("div",{className:"clearfix",style:{textAlign:"left",marginTop:"0.2rem"},children:[e.jsx("span",{className:"x-title",children:t.jobTitle})," ",t.content,"."," ",t.company&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"x-company",children:t.company}),","," "]}),t.location,e.jsx("span",{className:"x-date",children:t.date})]});c.createRoot(document.getElementById("root")).render(e.jsx(d.StrictMode,{children:e.jsx(u,{})}));
