...
<ul>
  ...
  <li><u>Development of automated tests</u>: developed security related functional tests (on
...
lights, XMPP messages for phone/watch notifications…</li>
  ...
  <li>DevOps/deployment tools: Created <b>Ansible</b> scripts automating the deployment to multipledevices: installing multiple systemd services (nginx, gunicorn, XMPP server…), setting up as a
...
offset, Phase+Timing error, IQ imbalance measurements.</li>
  ...
  <li>Development & bug-fixing using <b>C++</b> for: Bluetooth, WLAN, TDSCDMA, UMTS, LTE.</li>
...
profiling was done using Visual Studio.</li>
  ...
  <li>Test framework: Designed and implemented a test framework in <b>Matlab Object Oriented</b>,
generating impaired input data to exercise Agilent VSA and our own DLLs.</li>

</ul>`}],education:[{jobTitle:"5yr-MSc Telecoms & Signal Processing",company:"ESIEE-Paris",location:"France",date:"Sep 1994 - Sep 1999",content:"equivalent"},{jobTitle:"MSc Telecoms",company:"King's College London",location:"UK",date:"Jan 1998 - Jun 1998",content:"non-award exchange student"},{jobTitle:"Postgraduate Diploma in Management Studies",location:"bcuc.ac.uk",date:"Sep 2001 - Jul 2002",content:"part-time"}]},m=()=>{const t=n.fullname.split(" ").at(-1);return document.title=`CV_${t}_Python`,e.jsxs(e.Fragment,{children:[e.jsxs("header",{className:"x-no-print",style:{padding:"1rem",backgroundColor:"#ddd"},children:[e.jsx(u,{variant:"primary",onClick:()=>window.print(),style:{padding:"0 0.4rem"},children:"Print"}),e.jsxs("p",{children:["Note: Click ",e.jsx("strong",{children:"Print"}),", then expand ",e.jsx("strong",{children:"More settings"}),", then set"," ",e.jsx("strong",{children:"Margins = Custom"})," (20mm each side) and tick"," ",e.jsx("strong",{children:"Background graphics"})]})]}),e.jsxs("main",{children:[e.jsx("p",{className:"x-colored",style:{fontSize:"1.4rem"},children:n.fullname}),e.jsx("p",{className:"x-colored",style:{margin:"0.4rem auto"},children:n.jobTitle}),e.jsx("p",{children:[n.address,n.email,n.phone,n.nationality].join(" ♦ ")}),e.jsx(r,{children:"Profile"}),e.jsx("ul",{children:n.profileLines.map((o,i)=>e.jsx("li",{children:a(o)},i))}),e.jsx(r,{children:"Skills"}),e.jsx("ul",{children:Object.entries(n.skills).map((o,i)=>{const[s,l]=o;return e.jsxs("li",{children:[e.jsx("u",{children:s}),": ",a(l)]},i)})}),e.jsx(r,{children:"Work Experience"}),n.jobs.map((o,i)=>e.jsx(p,{item:o},i)),e.jsx(r,{children:"Education"}),n.education.map((o,i)=>e.jsx(h,{item:o},i))]})]})},r=t=>e.jsx("p",{className:"x-section",children:t.children}),p=({item:t})=>e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:{textAlign:"left",marginTop:"0.6rem"},children:[e.jsx("span",{className:"x-title",children:t.jobTitle}),"."," ",e.jsx("span",{className:"x-company",children:t.company}),", ",t.location,". (",t.sector,")",e.jsx("span",{className:"x-date",children:t.date})]}),e.jsx("div",{style:{textAlign:"justify"},children:a(t.content)})]}),h=({item:t})=>e.jsxs("div",{style:{textAlign:"left",marginTop:"0.2rem"},children:[e.jsx("span",{className:"x-title",children:t.jobTitle})," ",t.content,"."," ",t.company&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"x-company",children:t.company}),","," "]}),t.location,".",e.jsx("span",{className:"x-date",children:t.date})]});c.createRoot(document.getElementById("root")).render(e.jsx(d.StrictMode,{children:e.jsx(m,{})}));
