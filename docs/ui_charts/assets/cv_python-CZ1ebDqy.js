...
multiple instances of Behave in parallel in our GitLab CI/CD pipelines.</li>
...
services (API / Kafka / MongoDB), Pydantic validation, code coverage and Allure reports.</li>
  ...
  <li>Automated Test Development:
created back-end / API automated tests for new features (e.g. for adding new third party APIs).
Resolved issues with regression tests and GitLab CI/CD pipelines.
</li>
...
`,education:[{jobTitle:"5yr-MSc Telecoms & Digital Signal Processing",company:"ESIEE-Paris",location:"France",date:"1999",content:"equivalent"},{jobTitle:"MSc Telecoms",company:"King's College London",location:"UK",date:"1998",content:"non-award exchange student"},{jobTitle:"Postgraduate Diploma in Management Studies",location:"bucks.ac.uk",date:"2002",content:"part-time"}]},g=()=>e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"x-colored",style:{fontSize:"1.8rem"},children:i.fullname}),e.jsx("p",{className:"x-colored",style:{fontSize:"1.1rem",margin:"0 auto 1.3rem"},children:i.jobTitle}),e.jsxs("p",{children:[e.jsx(o,{className:"fa-solid fa-phone-volume"})," ",i.phone,e.jsx(o,{className:"fa-solid fa-envelope"})," ",i.email,e.jsx(o,{className:"fa-solid fa-house"})," ",i.address,e.jsx(o,{className:"fa-solid fa-passport"})," ",i.nationality]})]}),o=({className:t,...n})=>{const a={...n,className:"x-icon "+t};return e.jsx("i",{...a})},h=()=>{const t=i.fullname.split(" ").at(-1),n=new Date,a=n.getTimezoneOffset()*6e4,l=new Date(n.getTime()-a).toISOString().substring(0,10),c=`CV_${t}_Python_${l}`;return document.title=c,e.jsxs("header",{className:"x-no-print",children:[e.jsx(p,{variant:"dark",onClick:()=>window.print(),style:{padding:"0 0.5rem",marginBottom:"0.5rem"},children:"Print as PDF"}),e.jsxs("p",{children:["Click and select ",e.jsx("em",{children:'"Save as PDF"'})," to save as"," ",e.jsxs("code",{children:[c,".pdf"]}),"."]}),e.jsxs("p",{children:["NB: ensure ",e.jsx("em",{children:'"Headers and footers"'})," is disabled."]})]})},b=({item:t})=>{const n="x-heading-"+t.company.toLowerCase().replaceAll(" ","-");return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"clearfix","data-testid":n,style:{textAlign:"left",marginTop:"0.8rem"},children:[e.jsx("span",{className:"x-title",children:t.jobTitle})," |"," ",e.jsx("span",{className:"x-company",children:t.company}),", ",t.location,". (",t.sector,")",e.jsx("span",{className:"x-date",children:t.date})]}),e.jsx("div",{style:{textAlign:"justify"},children:r(t.content)})]})},f=({item:t})=>e.jsxs("div",{className:"clearfix",style:{textAlign:"left",marginTop:"0.2rem"},children:[e.jsx("span",{className:"x-title",children:t.jobTitle})," ",t.content,"."," ",t.company&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"x-company",children:t.company}),","," "]}),t.location,e.jsx("span",{className:"x-date",children:t.date})]}),y=()=>(u(()=>{if(!document.querySelector(".x-print-page-break")){const t=document.createElement("div");t.classList.add("x-print-page-break");const n=document.querySelector(i.pageBreakSelector);n?(n.style.marginTop="0",n.parentNode.insertBefore(t,n)):alert("Cannot find where to put the page break: "+i.pageBreakSelector)}},[]),e.jsxs(e.Fragment,{children:[e.jsx(h,{}),e.jsxs("main",{children:[e.jsx(g,{}),e.jsx(s,{children:"Profile"}),e.jsx("ul",{id:"x-profile",children:i.profileLines.map((t,n)=>e.jsx("li",{children:r(t)},n))}),e.jsx(s,{children:"Skills"}),Object.entries(i.skills).map((t,n)=>{const[a,l]=t;return e.jsxs("div",{className:"x-skills-pair",children:[e.jsxs("div",{className:"x-skills-group",children:[e.jsx("span",{className:"x-colored",children:a}),":"]}),e.jsx("div",{className:"x-skills-value",children:r(l)})]},n)}),e.jsx(s,{children:"Work Experience"}),i.jobs.map((t,n)=>e.jsx(b,{item:t},n)),e.jsx("p",{style:{textAlign:"left",marginTop:"0.8rem"},children:r(i.workExtra)}),e.jsx(s,{children:"Education"}),i.education.map((t,n)=>e.jsx(f,{item:t},n))]})]})),s=({className:t,...n})=>{const a={...n,className:"x-section"+(t?" "+t:"")};return e.jsx("p",{...a,children:n.children})};d.createRoot(document.getElementById("root")).render(e.jsx(m.StrictMode,{children:e.jsx(y,{})}));
