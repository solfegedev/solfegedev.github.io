...
services (API / Kafka / MongoDB), Pydantic validation, code coverage and Allure reports.</li>
  ...
  <li>Development of automated tests:
developed back-end / API automated tests for new features (e.g. for adding a new third party APIs).
Also bug-fixing issues with our regression tests and Gitlab CI/CD pipelines.
</li>
